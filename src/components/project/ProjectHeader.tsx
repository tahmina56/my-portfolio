  ...
  return (
    <div className="rounded-lg shadow-lg p-8 mb-8" style={{ backgroundColor: themeColors.card.background }}>
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4 mt-4">
            <a
              href={githubUrl}
              target="_blank"
              aria-label="Просмотреть исходный код на GitHub (открывается в новой вкладке)"
      ...
      <div className="border-t pt-6" style={{ borderColor: themeColors.card.border }}>
        <h2 className="text-2xl font-semibold mb-4" style={{ color: themeColors.text.primary }}>Ключевые особенности</h2>

...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: [
        "Описание вашей роли и достижений",
        "Еще одно достижение или обязанность",
        "Еще одно ключевое достижение",
      ]
    },
    {
      title: "Ваша должность",
  ...
  return (
    <section id="experience" className="py-8 relative" style={{
      ...
      <div className="container mx-auto px-6 relative" style={{ zIndex: 2 }}>
        <h2 className="text-4xl font-bold text-center mb-6" style={{ color: isDarkMode ? themeColors.colors.white : themeColors.colors.pink[500] }}>Опыт</h2>

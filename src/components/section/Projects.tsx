...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Jarvis",
      description: "ai assistant like jarvis",
      technologies: ["JS", "HTML", "OpenAI API"],
      icon: comingSoon,
    ...
    {
      title: "AgroTech",
      description: "AgroTech — это цифровая платформа для умного управления водными ресурсами в сельском хозяйстве. Система помогает фермерам и водным организациям эффективно распределять воду с помощью анализа данных.",
    ...
    {
      title: "kyrgyzstan1977.kg",
      description: "Это официальный сайт спортивного турнира, который организуют и проводят мужчины 1977 года рождения (традиционные ежегодные дружеские или региональные соревнования/встречи выпускников и ровесников в Кыргызстане).",
      technologies: ["JavaScript", "Vercel", "Supabase", "React"],
      icon: comingSoon,
    ...
    {
      title: "ILEC",
      description: "Официальный многостраничный сайт лицензированного образовательного агентства ILEC (International Language Education Center), у которого есть филиалы в Оше и Бишкеке. Проект служит полноценной платформой для привлечения клиентов",
      technologies: ["Tilda", "HTML", "CSS"],
      icon: comingSoon,
    ...
    >
      ...
      >
        <img
          ...
          alt="Звезда, которую можно потянуть"
          style={{
            width: '100%',
            height: '100%',
            pointerEvents: 'none'
      ...
      <TooltipProvider delayDuration={200}>
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex items-center justify-center gap-1 mb-4">
            <h2 className="text-4xl font-bold" style={{ color: isDarkMode ? themeColors.colors.white : themeColors.colors.pink[500] }}>Проекты</h2>
            <Tooltip>
              <TooltipTrigger asChild>
                <button 
                  className="inline-flex items-center justify-center bg-transparent border-none outline-none focus:outline-none" 
                  style={{ minWidth: '44px', minHeight: '44px' }}
                  aria-label="Информация об иконках проекта"
                >
                  <Heart
              ...
              <TooltipContent className="bg-white text-gray-800 border-pink-200">
                <p>все иконки созданы мной!</p>
              </TooltipContent>
            </Tooltip>
          </div>
          <p className="text-center mb-12 text-lg text-gray-600 dark:text-gray-300">
            Здесь представлены проекты, над которыми я работала недавно
          </p>
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 relative" style={{
                ...
                <CardHeader>
                  <div className="flex items-start gap-3">
                    {project.icon && (
                      <img
                        src={project.icon}
                        alt={`Иконка проекта ${project.title}`}
                ...
                <CardContent style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div className="flex gap-3" style={{ marginTop: 'auto', paddingTop: '8px' }}>
                    <Link to={project.detailsUrl} className="project-btn flex items-center gap-1" style={{ textDecoration: 'none', color: 'white' }} aria-label={`Просмотреть детали проекта ${project.title}`}>
                      <ExternalLink className="h-4 w-4" aria-hidden="true" />
                      Подробнее
                    </Link>
                    <a href={project.githubUrl} className="project-btn-outline flex items-center gap-1" style={{ textDecoration: 'none' }} target="_blank" rel="noopener noreferrer" aria-label={`Посмотреть исходный код проекта ${project.title} на GitHub`}>
                ...
                <CardHeader>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <CardDescription className="text-gray-600 dark:text-gray-300 mt-2">
                        Скоро появятся новые проекты! Возвращайтесь позже, чтобы увидеть, над чем я работаю.
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>

...
const ImageCarousel = ({ images, projectName }: ImageCarouselProps) => {
  ...
  return (
    <div className="rounded-lg p-8 mb-8" style={{ 
      ...
      <h2 className="text-2xl font-semibold mb-6" style={{ color: themeColors.text.primary }}>Скриншоты проекта</h2>
          ...
          >
            {images.map((image, index) => (
              <img 
                key={index}
                src={image} 
                alt={`${projectName} скриншот ${index + 1}`}
        ...
        >
          <div className="relative max-w-[70vw] max-h-[70vh]">
            <img
              ...
              alt={`${projectName} скриншот ${currentIndex + 1} в увеличенном виде`}
